...
public class DiskDonkey
{
    static void Main(string[] args)
    {
        ...
        CalculateDirectorySizesRecursive(start_path, 0, max_depth, results, min_size_gb * (1024 * 1024 * 1024));
        ...
        {
            output_lines.Add($"{item.human_readable_size} | {item.path}");
        }
